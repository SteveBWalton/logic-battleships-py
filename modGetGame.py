...
def GetGame(index, oArgs):
    ...
    if index == 1:
        ...
        oGame = battleships.CBattleships(9, 5, 'Logic Problems Battleships Number 37', oArgs)
        oGame.horizontal[0] = 3
        oGame.horizontal[1] = 2
        oGame.horizontal[2] = 7
        oGame.horizontal[3] = 1
        oGame.horizontal[4] = 5
        oGame.horizontal[5] = 1
        oGame.horizontal[6] = 2
        oGame.horizontal[7] = 4
        oGame.horizontal[8] = 0
        oGame.vertical[0] = 4
        oGame.vertical[1] = 1
        oGame.vertical[2] = 5
        oGame.vertical[3] = 0
        ...
        oGame = battleships.CBattleships(9, 5, 'Logic Problems Battleships Number 38', oArgs)
        oGame.horizontal[0] = 4
        oGame.horizontal[1] = 3
        oGame.horizontal[2] = 4
        oGame.horizontal[3] = 2
        ...
        oGame.negative_mask[6] = 2 + 4 + 8
        oGame.negative_mask[7] = 2 + 8 + 16 + 32
        oGame.negative_mask[8] = 2 + 8 + 32

    elif index == 39:
        oGame = battleships.CBattleships(9, 5, 'Logic Problems Battleships Number 39', oArgs)
        oGame.horizontal[0] = 1
        oGame.horizontal[1] = 3
        oGame.horizontal[2] = 1
        oGame.horizontal[3] = 6
        oGame.horizontal[4] = 3
        oGame.horizontal[5] = 3
        oGame.horizontal[6] = 2
        oGame.horizontal[7] = 3
        ...
        oGame.negative_mask[2] = 2
        oGame.negative_mask[3] = 2
        oGame.negative_mask[4] = 2
        oGame.negative_mask[5] = 2
        oGame.negative_mask[6] = 2
        oGame.negative_mask[7] =  8 + 16 + 32
        oGame.negative_mask[8] =  8 + 32

    elif index == 40:
        oGame = battleships.CBattleships(9, 5, 'Logic Problems Battleships Number 40', oArgs)
        oGame.horizontal[0] = 1
        oGame.horizontal[1] = 5
        oGame.horizontal[2] = 1
        oGame.horizontal[3] = 5
        oGame.horizontal[4] = 1
        oGame.horizontal[5] = 3
        oGame.horizontal[6] = 4
        oGame.horizontal[7] = 3
        oGame.horizontal[8] = 2
        oGame.vertical[0] = 0
        oGame.vertical[1] = 5
        ...
        oGame.negative_mask[0] = 1 + 2 + 4 + 8 + 64
        oGame.negative_mask[1] = 1 + 8 + 64
        oGame.negative_mask[2] = 1 + 2 + 4 + 8 + 64
        oGame.negative_mask[3] = 1 + 64
        oGame.negative_mask[4] = 1 + 64
        oGame.negative_mask[5] = 1 + 64
        oGame.negative_mask[6] = 1 + 64
        oGame.negative_mask[7] = 1 + 64
        oGame.negative_mask[8] = 1 + 64

    elif index == 41:
        oGame = battleships.CBattleships(9, 5, 'Logic Problems Battleships Number 41', oArgs)
        oGame.horizontal[0] = 3
        oGame.horizontal[1] = 4
        oGame.horizontal[2] = 2
        oGame.horizontal[3] = 4
        oGame.horizontal[4] = 0
        oGame.horizontal[5] = 5
        oGame.horizontal[6] = 1
        oGame.horizontal[7] = 6
        oGame.horizontal[8] = 0
        ...
        oGame.negative_mask[0] = 2 + 8
        oGame.negative_mask[1] = 2 + 4 + 8

    elif index == 42:
        oGame = battleships.CBattleships(9, 5, 'Logic Problems Battleships Number 42', oArgs)
        oGame.horizontal[0] = 3
        oGame.horizontal[1] = 2
        oGame.horizontal[2] = 3
        oGame.horizontal[3] = 3
        ...
        oGame.horizontal[5] = 2
        oGame.horizontal[6] = 4
        oGame.horizontal[7] = 0
        oGame.horizontal[8] = 6
        oGame.vertical[0] = 0
        oGame.vertical[1] = 7
        oGame.vertical[2] = 1
        oGame.vertical[3] = 0
        ...
        oGame.negative_mask[0] = 1 + 8
        oGame.negative_mask[1] = 1 + 8
        oGame.negative_mask[2] = 1 + 8
        oGame.negative_mask[3] = 1 + 8 + 32 + 64 + 128
        oGame.negative_mask[4] = 1 + 8 + 32 + 128
        oGame.negative_mask[5] = 1 + 8 + 32 + 64 + 128
        oGame.negative_mask[6] = 1 + 8
        oGame.negative_mask[7] = 1 + 2 + 4 + 8 + 16 + 32 + 64 + 128 + 256
        oGame.negative_mask[8] = 1 + 8

    elif index == 43:
        oGame = battleships.CBattleships(9, 5, 'Logic Problems Battleships Number 43', oArgs)
        oGame.horizontal[0] = 5
        oGame.horizontal[1] = 3
        oGame.horizontal[2] = 2
        oGame.horizontal[3] = 0
        oGame.horizontal[4] = 6
        oGame.horizontal[5] = 1
        oGame.horizontal[6] = 1
        oGame.horizontal[7] = 2
        oGame.horizontal[8] = 5
        oGame.vertical[0] = 6
        oGame.vertical[1] = 2
        oGame.vertical[2] = 1
        oGame.vertical[3] = 5
        ...
        oGame.negative_mask[3] = 1 + 2 + 4 + 8 + 16 + 32 + 64 + 128 + 256
        oGame.negative_mask[4] = 4
        oGame.negative_mask[5] = 4 + 8 + 16 + 32

    elif index == 44:
        oGame = battleships.CBattleships(9, 5, 'Logic Problems Battleships Number 44', oArgs)
        oGame.horizontal[0] = 5
        oGame.horizontal[1] = 0
        oGame.horizontal[2] = 5
        oGame.horizontal[3] = 1
        oGame.horizontal[4] = 0
        oGame.horizontal[5] = 7
        oGame.horizontal[6] = 2
        oGame.horizontal[7] = 3
        oGame.horizontal[8] = 2
        oGame.vertical[0] = 3
        ...
        oGame.negative_mask[1] = 4 + 8 + 16 + 32
        oGame.negative_mask[2] = 32
        oGame.negative_mask[3] = 4 + 8 + 16 + 32

    elif index == 45:
        oGame = battleships.CBattleships(9, 5, 'Logic Problems Battleships Number 45', oArgs)
        oGame.horizontal[0] = 1
        oGame.horizontal[1] = 4
        oGame.horizontal[2] = 2
        oGame.horizontal[3] = 5
        ...
        oGame.negative_mask[0] = 1
        oGame.negative_mask[1] = 1
        oGame.negative_mask[2] = 1
        oGame.negative_mask[3] = 1
        oGame.negative_mask[4] = 1
        oGame.negative_mask[5] = 1
        oGame.negative_mask[6] = 1
        oGame.negative_mask[7] = 1
        oGame.negative_mask[8] = 1
